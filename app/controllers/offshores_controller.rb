class OffshoresController < ApplicationController
    ...
    redirect_to offshores_path
      ...
      render 'new'
        ...
        #strong parameters
    def shore
        params.require(:offshore).permit(field_name, :status_status, :original_operator, :current_operator, :discovery_yr, :resource, :field_size_boe, 
        :first_production_yr, :estimated_end_production, :field_life_yrs, :water_depth, :capex_usd,:distance_to_shore_km, :no_manifolds, :no_installed_trees)
    end
